  ...
  return (
    <main className="min-h-screen flex flex-col text-black font-sans pb-24">
      ...
      <section className="max-w-[1400px] mx-auto px-4 lg:px-10 pt-24 pb-10 text-center">
        ...
        <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight mb-4 text-black">
          Bot Subscription
        </h1>
      ...
      <section className="max-w-7xl mx-auto px-4 lg:px-8 pb-10 lg:pb-16 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 items-stretch lg:items-center">
          {accessPlans.map((plan, i) => (
            <Card
              key={i}
              className={`flex flex-col cursor-pointer justify-between rounded-4xl transition-all duration-300 overflow-hidden relative backdrop-blur-md border bg-black text-neutral-50
                ${
                  plan.popular
                    ? "lg:scale-[1.06] z-10 border-indigo-900/60 shadow-2xl shadow-indigo-950/60 ring-1 ring-indigo-500/40 py-4 lg:py-8"
            ...
            >
              ...
              <div className={`absolute top-0 inset-x-0 h-50 ${plan.headerBg} pointer-events-none`} />

              {/* Header */}
              <CardHeader className="px-7 pt-7 relative z-10">
                <div className="flex justify-between items-start mb-2">
                  {/* Brand Circular Icon */}
                  <div className={`w-10 h-10 rounded-full bg-gradient-to-tr ${plan.iconGrad} p-0.5 flex items-center justify-center shadow-lg`}>
              ...
              <div className="px-7 py-4 relative z-10">
                <button
                  ...
                  className={`w-full cursor-pointer text-sm py-3 px-4 rounded-full transition-all duration-300 flex items-center justify-center gap-2 ${plan.btnClass}`}
                >
              ...
              {/* Body Content */}
              <CardContent className="px-7 pb-7 flex-grow flex flex-col justify-between gap-6 relative z-10">
                {/* Stats row */}
