...
export default function SubscriptionPage() {
  ...
  return (
    <main className="flex flex-col text-neutral-50 font-sans">
      {/* Hero Header */}
      <section className="max-w-7xl mx-auto px-4 lg:px-10 pb-10 text-center mt-5">
  ...
  <p className="text-neutral-600 max-w-2xl text-sm md:text-base leading-relaxed mx-auto font-medium">
    ...
    and risk-managed execution designed for your selected package.
      ...
      <section className="max-w-7xl mx-auto px-4 lg:px-10 pb-10 lg:pb-14 w-full">
        ...
        {/* Disclaimer */}
        <div className="max-w-4xl mx-auto mt-4 lg:mt-10 px-5 py-4 border border-neutral-800 bg-neutral-950 rounded-none">
